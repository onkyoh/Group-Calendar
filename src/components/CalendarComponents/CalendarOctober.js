  ...
  return (
    <Container>
        ...
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0 ' ></Col>
            <Col className='border-end p-0 ' ></Col>
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[5][1].availability}`}>1</Button></Col>            
        </Row>
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[5][8].availability}`}>8</Button></Col>     
        </Row>
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[5][15].availability}`}>15</Button></Col>
        </Row>
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[5][22].availability}`}>22</Button></Col>
        </Row>
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[5][29].availability}`}>29</Button></Col>
        </Row>
        <Row>
