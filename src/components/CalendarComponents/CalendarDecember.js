  ...
  return (
    <Container>
        ...
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[7][10].availability}`}>10</Button></Col>
            <Col className='p-0' ><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[7][11].availability}`}>11</Button></Col>
        </Row>
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[7][17].availability}`}>17</Button></Col>
            <Col className='p-0' ><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[7][18].availability}`}>18</Button></Col>
        </Row>
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[7][24].availability}`}>24</Button></Col>
            <Col className='p-0' ><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[7][25].availability}`}>25</Button></Col>
        ...
        <Row className='border border-top-0'>
            ...
            <Col className='border-end p-0'><Button onClick={handleCurrentDay} className={`w-100 btn rounded-0 shadow-none btn-${storage[7][31].availability}`}>31</Button></Col>
